...
const chartData = [
  ...
  { month: "August", desktop: 210, mobile: 140 },
  { month: "September", desktop: 114, mobile: 140 },
  { month: "October", desktop: 193, mobile: 140 },
  { month: "November", desktop: 144, mobile: 140 },
  { month: "December", desktop: 104, mobile: 140 },
];
...
export function Barchart() {
  return (
    <Card className="h-full flex flex-col justify-between">
      ...
      <CardContent>
        <ChartContainer className="w-full max-h-[250px]" config={chartConfig}>
